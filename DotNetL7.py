...
def main():
    global ATTACKING_STATUS, THREADS_COUNT, DELAY_BETWEEN_CONNECTIONS, RUNNING_THREADS, USER_AGENTS, VERSION_INSTALLED
 ...
 Author: @r_RiX_x                             |__/   Version: 1.00
    """
    print(welcome_text)

    #define version installed
    VERSION_INSTALLED = "1.00"
...
def get_options():
    global ATTACKING_STATUS, TARGET, THREADS_COUNT, DELAY_BETWEEN_CONNECTIONS, SSL, HOST, VERSION_INSTALLED
